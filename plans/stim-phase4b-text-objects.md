...
**Status**: Design (pre-implementation). The payoff of the range model and the one
grammar phase that needs real data-structure evolution. Builds on P4a (word motions).
