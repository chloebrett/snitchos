# Post 81 — profiling drivel on the VF2: every guess was wrong
...
- the through-line is uncomfortable and worth stating first: every time I reasoned about where the cost was, I was wrong. every time I built a small thing that could check itself, it told me something I would not have guessed. that is [post 80](post-80-checkpoint-vocab-pairing.md)'s lesson again — *measure the discrimination somewhere cheap* — except this time the thing that needed measuring was my own ranked list.
