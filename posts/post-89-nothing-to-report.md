...
- [post 80](post-80-the-control-passed-twice.md) was about a control that passes while checking nothing. [post 88](post-88-presented-is-not-drawn.md) was about a proxy that cannot fail. this one is the negative-space version of both: **code that is live, correct, and unreachable** — a metric that increments forever and never arrives.
