# Post 83 — the file disagreed with itself
...
- [post 79](post-79-the-correction-made-the-same-mistake.md) is the ancestor: *a note that contradicts its own source is worse than no note.* this is that one level down. these notes did not contradict some distant source. **they contradicted the rest of their own file.**
