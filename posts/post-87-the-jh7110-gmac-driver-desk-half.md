# Post 87 — the JH7110 GMAC driver, desk half
...
- [post 80](post-80-checkpoint-vocab-pairing.md) was about guards that pass while checking nothing. [post 82](post-82-snitchos-in-a-browser-tab.md) was about a diagnosis inherited rather than derived. this is the next one along, and the nastiest: **mutual confirmation between things that share an ancestor.**
...
- [post 80](post-80-checkpoint-vocab-pairing.md): a control that passes because the question was too easy.
- [post 82](post-82-snitchos-in-a-browser-tab.md): a diagnosis that fits the evidence and was inherited rather than derived.
