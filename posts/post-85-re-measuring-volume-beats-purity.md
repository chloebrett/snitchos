# Post 85 — re-measuring "volume beats purity" at 2.3× the corpus
...
- `examples/stitch/` is 30 hand-polished gold programs, the deliverable of [stitch 18](stitch-18-thirty-example-programs.md), which ended on "what they're worth to an actual model is the next measurement". they sit inside every arm as part of `--real-root` and nobody had measured them.
...
- [post 77](post-77-training-loss-is-blind-to-memorisation.md) already established parse rate cannot resolve checkpoints half a nat apart. this is the stronger version: **it cannot resolve them across the entire history of the project.**
